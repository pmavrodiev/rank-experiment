  ...
  window.rank_experiment = (function() {
    ...
    function rank_experiment() {
      ...
      */
      ...
      this.serverURL = "http://129.132.183.93:8070";
    ...
    rank_experiment.prototype.windowListen = function() {
      ...
      initInstructions = function() {
        _this.instructionVector[0] = "Welcome to our guessing game." + "The purpose of the game is to find out the location of a hidden point " + "randomly positioned on the blue circle to the left." + "You will compete with other players, and your performance, as well as reward, " + "will be based on how close your guess is to the hidden point, compared to others.\n\r" + "The game consists of 3 identical stages. Each stage, in turn, consists of 10 rounds." + "During each round, you make a guess " + "by moving the green line around the circle and clicking on a desired position. " + "A round finishes when all players have made their choices. A stage finishes after round 10 is over.\n\r" + "You have 30 seconds to submit a guess. Failure to do so will generate a random guess for that round." + "\n\r" + "Note that the position of the hidden point is the same during a stage but changes in every stage!\n\r" + "At the beginning of round 1 of each stage, you will be assigned a random guess. It is used to calculate your starting rank for this stage." + "Your rank is 1 if you are the player currently closest to the hidden point. " + "Similarly, if you are farthest from the point, you rank last.\n\r" + "Your payoff is based on your final rank at the end of each stage. Normally, you would receive monetary compensation." + "However, in this version you play for unlimited bragging rights about your intelligence. Good luck!\n\r" + "To continue, enter a username in the box below and click \"Next\" for a quick practice.";
